...
import ModalTambahMateriRekap from "./ModalTambahMateriRekap";
...
import ModalTambahTugas from "./ModalTambahTugas";

const DaftarRekapTugas = ({
  dataRekapTugas,
  idRekap,
  _getDetailRekap,
  loading,
                      ...
                      return (
                        <tr key={idx}>
                          ...
                          <td data-th="Rekap Nilai">
                            <Link
                              href={`${ssURL}/rekap/${idRekap}/materi/${d?.id}`}
                            >
...
export default DaftarRekapTugas;
